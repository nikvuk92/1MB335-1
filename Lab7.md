...
With the dawn of genetic sequencing and the genomic era, we can now establish those relationships with quite more certainty and in a less biased way. Using genetic data for inferring these relationships is known as Phylogenetics, and it is the "gold-standard" when establishing the relationship between modern species. 
